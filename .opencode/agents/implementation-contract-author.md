...
3. **Search the wiki** — Use wiki search tools (`wiki_search`, `wiki_search_exact`, `wiki_read_section`) to find relevant architecture context, dependency maps, module boundaries, data flow, and existing conventions.
