...
`.specs/sprint-2026-05/architecture-refactor-device-window-platform/spec.md` — SPEC-016.
...
- `.specs/sprint-2026-05/architecture-refactor-device-window-platform/coordination.md` — Must be updated (see after-writing instructions).
