...
The implementation contract (`.specs/sprint-2026-05/capture/implementation-contract.md`) and spec
(`.specs/sprint-2026-05/capture/spec.md`) already document the design rationale, architecture boundary
