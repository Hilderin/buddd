...
`.specs/sprint-2026-05/cli-command-system/spec.md` (SPEC-006, Status: `Accepted`)
...
- `.specs/sprint-2026-05/cli-command-system/spec.md` already documents the new CLI interface.
