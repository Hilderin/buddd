...
All edge cases from the spec (see `.specs/sprint-2026-05/depth-handling/spec.md#edge-cases`) must be handled as follows:
...
None. No README, wiki, or API documentation files are modified. The spec (`.specs/sprint-2026-05/depth-handling/spec.md`) serves as the primary reference.
