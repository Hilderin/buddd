...
`.specs/sprint-2026-05/input-system/spec.md` (SPEC-013), accepted (`.specs/sprint-2026-05/input-system/spec-critic.md` verdict: `Accept` — both blocking issues resolved, spec ready for implementation-contract authoring).
...
| `.specs/sprint-2026-05/platform-abstraction/implementation-contract.md` | Style reference (IMPL-002) for contract format and level of detail. |
| `.specs/sprint-2026-05/render-pipeline/implementation-contract.md` | Style reference (IMPL-005) for contract format and level of detail. |
