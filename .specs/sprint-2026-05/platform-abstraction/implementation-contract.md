...
`.specs/sprint-2026-05/platform-abstraction/spec.md` (SPEC-002), accepted (`.specs/sprint-2026-05/platform-abstraction/spec-critic.md` verdict: `Accepted with warnings`, all blocking issues resolved).
...
| `.specs/sprint-2026-05/platform-abstraction/spec.md` | Authoritative spec for behavior. |
| `.specs/sprint-2026-05/project-setup/implementation-contract.md` | Style reference (IMPL-001) for contract format and level of detail. |
...
- The spec (`.specs/sprint-2026-05/platform-abstraction/spec.md`) remains authoritative.
