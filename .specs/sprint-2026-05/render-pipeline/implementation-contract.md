...
`.specs/sprint-2026-05/render-pipeline/spec.md` (SPEC-005), accepted.

All blocking issues from the spec-critic review (`.specs/sprint-2026-05/render-pipeline/spec-critic.md`) have been resolved:
...
- The spec (`.specs/sprint-2026-05/render-pipeline/spec.md`) remains authoritative.
