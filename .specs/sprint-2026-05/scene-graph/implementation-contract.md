...
`.specs/sprint-2026-05/scene-graph/spec.md` (SPEC-008), accepted (`.specs/sprint-2026-05/scene-graph/spec-critic.md` 2nd review verdict: `Accepted`, all 5 blocking issues resolved).
...
| `.specs/sprint-2026-05/math-foundations/implementation-contract.md` | Style reference for contract format, level of detail, and pseudo-code conventions. |
| `.specs/sprint-2026-05/render-pipeline/implementation-contract.md` | Reference for the ADR-001 exception pattern (`draw()`/`draw_indexed()` return `void`). |
...
All edge cases from the spec (see `.specs/sprint-2026-05/scene-graph/spec.md#edge-cases`) must be handled. The implementation must handle these cases as follows:
