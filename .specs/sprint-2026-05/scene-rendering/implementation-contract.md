...
- `.specs/sprint-2026-05/scene-rendering/spec.md` (SPEC-011), accepted.
- `.specs/sprint-2026-05/scene-rendering/spec-critic.md` — re-review verdict: `Accepted with warnings`. All 8 blocking issues resolved. Non-blocking concerns W-08 (headless uniform query), W-09 (headless counters), and W-10 (AC-023 escape hatch) are addressed in this contract.
...
- `.specs/sprint-2026-05/scene-rendering/README.md` — should mention the new files and their roles (if such a README exists; otherwise defer).
