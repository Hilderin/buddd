...
- [ ] **CR-01: Implementation contract out of sync — Warnings field missing from template definition and all "After writing" sections.**
  ...
  The accepted implementation contract (`.specs/sprint-2026-05/workflow-coordination/implementation-contract.md`) was written before the Warnings field was added to the spec. It is now contradictory to the spec in two significant ways:
...
- [ ] **R-01 (Implementation contract update):** Update `.specs/sprint-2026-05/workflow-coordination/implementation-contract.md` to:
