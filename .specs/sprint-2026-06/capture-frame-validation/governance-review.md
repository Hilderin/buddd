...
| # | Document | Status |
|---|---|---|
| 1 | `.specs/sprint-2026-05/capture-frame-validation/coordination.md` | Workflow coordination, all gates checked |
| 2 | `.specs/sprint-2026-05/capture-frame-validation/spec.md` (SPEC-009) | Spec: auto-set, validation, effective_frame() |
| 3 | `.specs/sprint-2026-05/capture-frame-validation/spec-critic.md` | Reviewed, accepted — no blocking issues |
| 4 | `.specs/sprint-2026-05/capture-frame-validation/implementation-contract.md` (IMPL-009) | Contract: detailed implementation instructions |
| 5 | `.specs/sprint-2026-05/capture-frame-validation/implementation-contract-critic.md` | Reviewed, accepted — all issues resolved |
| 6 | `.specs/sprint-2026-05/capture-frame-validation/code-review.md` | Code review — all 12 AC satisfied, 366 tests pass |
| 7 | `.specs/sprint-2026-06/cli-app-system/spec.md` (SPEC-008) | Parent spec — edge cases 524/525 superseded |
| 8 | `.specs/sprint-2026-06/cli-app-system/implementation-contract.md` (IMPL-008) | Parent contract — rows 928/929 updated |
