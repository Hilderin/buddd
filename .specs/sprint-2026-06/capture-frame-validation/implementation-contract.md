...
`.specs/sprint-2026-05/capture-frame-validation/spec.md` (SPEC-009), accepted. The spec-critic review (`.specs/sprint-2026-05/capture-frame-validation/spec-critic.md`) found no blocking issues. Verdict: accepted.
...
| `.specs/sprint-2026-06/cli-app-system/implementation-contract.md` | Edge case table rows 928–929 (frame > frame_limit and --capture 1:path) — must be updated to reference the new validation. |
...
| 5 | `.specs/sprint-2026-06/cli-app-system/implementation-contract.md` | Update edge case rows 928–929 to reflect that the validation is now in `parse_running_args()`. |
...
### 4. Update `.specs/sprint-2026-06/cli-app-system/implementation-contract.md`
...
- `.specs/sprint-2026-06/cli-app-system/implementation-contract.md`: Update edge case rows 928–929 to reflect new validation.
...
### Documentation
- [ ] `.specs/sprint-2026-06/cli-app-system/implementation-contract.md` edge case rows 928–929 updated to reflect new validation behavior.
