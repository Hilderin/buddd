...
- **SPEC-008 numbering collision**: Two specs share the number `008` (`.specs/sprint-2026-06/cli-app-system/spec.md` and `.specs/sprint-2026-05/scene-graph/spec.md`). This is a pre-existing project issue not introduced by this workflow. Consider renumbering to avoid confusion in future work.
