...
- `.specs/sprint-2026-06/asset-manager/spec.md` — Update the non-goals section (currently states "No glTF/glb model loading (models remain programmatic for V1)") to reflect that glTF loading is now supported.
