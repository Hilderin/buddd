...
- `wiki_wiki_search` — hybrid (FTS5 + vector) search for fuzzy/conceptual queries
- `wiki_wiki_search_exact` — exact lexical/FTS search for specific terms, IDs, file names
