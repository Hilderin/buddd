...
- SPEC-007 (`docs/specs/cli-command-evolution/spec.md`): Spec-level documentation of the demo system CLI interface.
- IMPL-007 (`docs/specs/cli-command-evolution/implementation-contract.md`): Contract-level implementation details including pseudo-code.
...
- SPEC-006 (`docs/specs/cli-command-system/spec.md`): The previous CLI command system that this design builds upon.
