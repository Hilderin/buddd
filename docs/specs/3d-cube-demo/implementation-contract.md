...
`docs/specs/3d-cube-demo/spec.md` (SPEC-009), accepted. All open questions (Q-01 through Q-05) are marked `[RESOLVED]`. All blocking issues (B-01 through B-05) from the spec-critic review have been resolved in the accepted spec.
...
All edge cases from the spec (see `docs/specs/3d-cube-demo/spec.md#edge-cases`) must be handled by the implementation as follows:
