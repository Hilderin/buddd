...
Evaluates `docs/specs/architecture-refactor-device-window-platform/implementation-contract.md` against the accepted spec (SPEC-016), existing codebase conventions, and constitutional rules.
