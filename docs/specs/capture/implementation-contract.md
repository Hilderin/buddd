...
`docs/specs/capture/spec.md` (SPEC-010), accepted.

All blocking issues (B-01 through B-03) from the spec-critic review (`docs/specs/capture/spec-critic.md`) have been resolved in the accepted spec:
