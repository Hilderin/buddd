...
`docs/specs/ci-docker-publish/spec.md` (SPEC-CI-001), accepted with no blocking issues according to `docs/specs/ci-docker-publish/spec-critic.md`.
...
| `docs/specs/ci-docker-publish/spec.md` | Source spec with full acceptance criteria, edge cases, and permission requirements. |
| `docs/specs/ci-docker-publish/spec-critic.md` | Spec review confirming no blocking issues remain. Lists warnings that may affect implementation choices. |
| `docs/specs/ci-docker-publish/coordination.md` | Workflow coordination document — must be updated after contract writing. |
| `docs/specs/ci-docker-publish/implementation-contract-critic.md` | Previous contract review that identified blocking issues (docker/build-push-action does not pull) — the current rewrite resolves these issues. |
