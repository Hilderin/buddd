...
Re-reviewed `docs/specs/gltf-model-loading/spec.md` after fixes for BL-001 and BL-002.

**BL-001**: RESOLVED. A "Documents requiring updates" section (lines 727-735) lists all 4 required documents: `docs/specs/asset-manager/spec.md`, `docs/wiki/architecture/module-map.md`, `docs/wiki/domain/glossary.md`, and a new tinygltf ADR in `docs/adr/`.
