...
`docs/specs/lighting/spec.md` (SPEC-018, accepted)
...
- `docs/` files other than this contract and `docs/specs/lighting/coordination.md`
...
- `docs/specs/lighting/implementation-contract.md` — this file.
- `docs/specs/lighting/coordination.md` — update `## implementation-contract-author` section.
