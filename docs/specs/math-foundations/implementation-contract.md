...
`docs/specs/math-foundations/spec.md` (SPEC-004), accepted (`docs/specs/math-foundations/spec-critic.md` verdict: `Accepted`, all 8 blocking issues resolved). All 4 re-review issues resolved. All non-blocking warnings are acknowledged.
...
| `docs/specs/platform-abstraction/implementation-contract.md` | Style reference (IMPL-002) — level of detail and format to match. |
| `docs/specs/math-foundations/spec.md` | Authoritative spec for behavior. |
...
- The spec (`docs/specs/math-foundations/spec.md`) remains authoritative.
