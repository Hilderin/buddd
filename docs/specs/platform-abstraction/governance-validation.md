...
- [x] **B-01 — CONST-001 status is incorrectly described in the implementation contract and wiki.** ✅ Fixed: Implementation contract and wiki updated to reflect CONST-001 as active rule.
  The implementation-contract (`docs/specs/platform-abstraction/implementation-contract.md`) §"Relevant constitution rules" states:
...
- [x] **`docs/specs/platform-abstraction/spec.md`** — Approval table filled: Approved by Guillaume, Date 2026-05-29, Time ~16:30 UTC. Section properly populated. ✅
- [x] **`docs/specs/platform-abstraction/implementation-contract.md`** — Approval table filled: Approved by Guillaume, Date 2026-05-29, Time ~16:30 UTC. Section properly populated. ✅

## Required governance updates

Concrete changes to governance documents:

1. **`docs/specs/platform-abstraction/implementation-contract.md`** — Update §"Relevant constitution rules" to reflect that CONST-001 is now an **active** rule with full content (not a TODO placeholder). Update §"Relevant ADRs" and §"ADR impact" to reference ADR-001 (Result<T>/Error Pattern).
