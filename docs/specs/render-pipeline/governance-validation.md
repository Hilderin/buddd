...
### Specs and contracts
- `docs/specs/render-pipeline/spec.md` — SPEC-005 (Render Pipeline)
- `docs/specs/render-pipeline/spec-critic.md` — Spec critic review
- `docs/specs/render-pipeline/implementation-contract.md` — IMPL-005
- `docs/specs/render-pipeline/implementation-contract-critic.md` — Contract critic review
- `docs/specs/render-pipeline/code-review.md` — Code review
...
- `docs/specs/platform-abstraction/spec.md`
- `docs/specs/math-foundations/spec.md`
...
**Files**: `docs/specs/render-pipeline/spec.md` (line 5), `docs/specs/render-pipeline/implementation-contract.md` (line 5)
...
**File**: `docs/specs/render-pipeline/implementation-contract.md`
